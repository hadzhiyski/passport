...
ALTER TABLE "vaccinations" ADD CONSTRAINT "vaccinations_administered_by_veterinarians_id_fk" FOREIGN KEY ("administered_by") REFERENCES "public"."veterinarians"("id") ON DELETE cascade ON UPDATE restrict;